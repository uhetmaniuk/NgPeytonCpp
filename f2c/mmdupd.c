/* mmdupd.f -- translated by f2c (version 20230428).
...
/* Subroutine */ int mmdupd_(integer *ehead, integer *neqns, integer *xadj, 
	integer *adjncy, integer *delta, integer *mdeg, integer *dhead, 
	...
	integer *marker, integer *maxint, integer *tag)
{
    ...
    /* Local variables */
    static integer i__, j, iq2, deg, deg0, node, mtag, link, mdeg0, enode, 
