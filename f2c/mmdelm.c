/* mmdelm.f -- translated by f2c (version 20230428).
...
/* Subroutine */ int mmdelm_(integer *mdnode, integer *xadj, integer *adjncy, 
	...
	integer *llist, integer *marker, integer *maxint, integer *tag)
{
    ...
    /* Local variables */
    static integer i__, j, npv, node, link, rloc, rlmt, nabor, rnode, elmnt, 
