/* epost2.f -- translated by f2c (version 20230428).
...
/* Subroutine */ int epost2_(integer *root, integer *fson, integer *brothr, 
	integer *invpos, integer *parent, integer *colcnt, integer *stack)
{
