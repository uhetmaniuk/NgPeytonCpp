/* mmdnum.f -- translated by f2c (version 20230428).
...
/* Subroutine */ int mmdnum_(integer *neqns, integer *perm, integer *invp, 
	integer *qsize)
{
    ...
    /* Local variables */
    static integer num, node, root, nextf, father, nqsize;
